...
public interface BroadPhaseStrategy extends Serializable {
	...
	/**
	 * Move a proxy with a swepted AABB. If the proxy has moved outside of its fattened AABB, then the proxy is removed from the tree
	 * and re-inserted. Otherwise the function returns immediately.
	 *
