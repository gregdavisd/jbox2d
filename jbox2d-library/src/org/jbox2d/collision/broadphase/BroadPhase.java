...
public interface BroadPhase extends Serializable {
	...
	/**
	 * Call MoveProxy as many times as you like, then when you are done call UpdatePairs to finalized the proxy pairs (for your time
	 * step).
	 */
